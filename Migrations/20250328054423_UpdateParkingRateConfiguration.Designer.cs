...
namespace ParkIRC.Migrations
{
    ...
    [Migration("20250328054423_UpdateParkingRateConfiguration")]
    partial class UpdateParkingRateConfiguration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ParkIRC.Models.ParkingRate", b =>
                {
                    ...
                    b.Property<decimal>("AdditionalHourRate")
                        ...
                        .HasColumnName("additional_hour_rate");
                    ...
                    b.Property<decimal>("MaximumDailyRate")
                        .HasColumnType("numeric")
                        .HasColumnName("maximum_daily_rate");
                    ...
                    b.ToTable("parking_rate_configurations", (string)null);
                });
            ...
            modelBuilder.Entity("ParkIRC.Models.SiteSettings", b =>
                {
                    ...
                    b.Property<string>("PostgresConnectionString")
                        .HasColumnType("text")
                        .HasColumnName("postgres_connection_string");
            ...
            modelBuilder.Entity("ParkIRC.Models.ParkingRateConfiguration", b =>
                {
                    b.HasBaseType("ParkIRC.Models.ParkingRate");
            ...
            modelBuilder.Entity("ParkIRC.Models.ParkingRateConfiguration", b =>
                {
                    b.HasOne("ParkIRC.Models.ParkingRate", null)
                        .WithOne()
                        .HasForeignKey("ParkIRC.Models.ParkingRateConfiguration", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
